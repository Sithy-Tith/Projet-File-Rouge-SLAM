 ...
 */
final class Version20260519170347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interventions CHANGE date date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interventions CHANGE date date DATETIME NOT NULL');
