 ...
 */
final class Version20260323153017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interventions (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, description LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, duration INT NOT NULL, fk_employee_id INT DEFAULT NULL, INDEX IDX_5ADBAD7FE5F55D68 (fk_employee_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE pieces (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(45) NOT NULL, quantity INT NOT NULL, alert_treshold INT NOT NULL, supplier VARCHAR(45) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
