 ...
 */
final class Version20260413173407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interventions (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, date DATETIME NOT NULL, description LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, duration INT DEFAULT NULL, fk_employee_id INT DEFAULT NULL, fk_client_id INT DEFAULT NULL, INDEX IDX_5ADBAD7FE5F55D68 (fk_employee_id), INDEX IDX_5ADBAD7F78B2BEB1 (fk_client_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
