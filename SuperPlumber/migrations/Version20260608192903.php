 ...
 */
final class Version20260608192903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE availabilities (id INT AUTO_INCREMENT NOT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, fk_employee_id INT DEFAULT NULL, INDEX IDX_D7FC41EFE5F55D68 (fk_employee_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE interventions (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, start_at DATETIME DEFAULT NULL, end_at DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, fk_employee_id INT DEFAULT NULL, fk_client_id INT DEFAULT NULL, fk_availability_id INT DEFAULT NULL, INDEX IDX_5ADBAD7FE5F55D68 (fk_employee_id), INDEX IDX_5ADBAD7F78B2BEB1 (fk_client_id), INDEX IDX_5ADBAD7FB8D4D053 (fk_availability_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
