...
final class Version20260323185654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE availibilities (id INT AUTO_INCREMENT NOT NULL, availibility INT NOT NULL, date DATE NOT NULL, fk_employee_id INT DEFAULT NULL, INDEX IDX_6C24E3F7E5F55D68 (fk_employee_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE availibilities ADD CONSTRAINT FK_6C24E3F7E5F55D68 FOREIGN KEY (fk_employee_id) REFERENCES employees (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE availibilities DROP FOREIGN KEY FK_6C24E3F7E5F55D68');
