 ...
 */
final class Version20260525210552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE availabilities ADD start DATETIME NOT NULL, ADD end DATETIME NOT NULL, DROP availability, DROP date');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE availabilities ADD availability INT NOT NULL, ADD date DATE NOT NULL, DROP start, DROP end');
