 ...
 */
final class Version20260525211104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interventions CHANGE description description LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interventions CHANGE description description LONGTEXT NOT NULL');
